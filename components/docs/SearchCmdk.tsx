      ...
      {open && mounted && createPortal(
        ...
        >
          <div
            ...
            className="w-full max-w-xl mx-4 bg-[#111] rounded-xl border border-neutral-800 shadow-2xl overflow-hidden"
          >
            <Cmdk shouldFilter={false} className="flex flex-col">
              ...
              <div className="flex items-center gap-3 px-4 py-3 border-b border-neutral-800">
                ...
                >
                  <kbd className="text-[11px] border border-neutral-700 bg-neutral-800 text-neutral-400 rounded px-1.5 py-0.5">
                    Esc
                  </kbd>
                </button>
              </div>
              ...
              <Cmdk.List className="max-h-105 overflow-y-auto py-1">
                <Cmdk.Empty className="py-12 text-center text-sm text-neutral-500">
                ...
                {!isSearching
                  ...
                  : filteredSections.map((section) => (
                    <div key={section.title}>
                      ...
                      <div className="flex items-center gap-3 px-4 py-2.5 text-[14px] text-neutral-200">
                        <FileText className="h-4.5 w-4.5 shrink-0 text-neutral-400" />
                        <span>{section.title}</span>
                      </div>

                      {/* Línea vertical + docs hijos */}
                      <div className="ml-[1.65rem] border-l border-neutral-700">
                        {section.items.map((item) => (
                          <Cmdk.Item
                            ...
                            className={cn(
                              ...
                              "text-neutral-300 text-[13px]",
                              "data-[selected=true]:bg-neutral-800",
                              "hover:bg-neutral-800/60"
                            )}
                          >
                            <AlignLeft className="h-3.5 w-3.5 shrink-0 text-neutral-500" />
              ...
              <div className="flex items-center justify-between px-4 py-2 border-t border-neutral-800">
                <div className="flex items-center gap-3 text-[11px] text-neutral-500">
                  <span className="flex items-center gap-1">
                    <kbd className="inline-flex items-center justify-center h-5 px-1 rounded border border-neutral-700 bg-neutral-800 text-[10px]">↑↓</kbd>
                    navegar
                  </span>
                  <span className="flex items-center gap-1">
                    <kbd className="inline-flex items-center justify-center h-5 px-1 rounded border border-neutral-700 bg-neutral-800 text-[10px]">↵</kbd>
                  ...
                  <span className="flex items-center gap-1">
                    <kbd className="inline-flex items-center justify-center h-5 px-1.5 rounded border border-neutral-700 bg-neutral-800 text-[10px]">esc</kbd>
                    cerrar
                  </span>
                </div>
